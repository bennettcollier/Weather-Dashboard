...
var populateNow = function (cityObj, UVindex) {
    ...
    var htmlStr = `<div class = "card-body">
        <h2 id="city-now" class = "card-title">${cityObj.name}  (${moment.unix(cityObj.dt).format("MM/DD/YYYY")})</h5>
        <img src="${iconurl}" alt="">
        <p class="card-text">Temperature: ${tempStr}</p>
        <p class="card-text">Humidity: ${cityObj.main.humidity}% </p>
        <p class="card-text">Wind Speed: ${cityObj.wind.speed} MPS</p>
...
var populateForecastCard = function (chunkObj) {
    ...
    dateStr = moment.unix(twoPmEl.dt).format("MM/DD/YYYY");
        ...
        <div class="card-body">
            ...
            <div class = "row">
                <div class="col">
                    ...
                    <img src="${"https://openweathermap.org/img/w/" + twoPmEl.weather[0].icon + ".png"}" alt=""> <br>
                    Temp: ${((twoPmEl.main.temp - 273.15) * 9 / 5 + 32).toFixed(1) + "&#176F"}
                    Humidity: ${twoPmEl.main.humidity}%                    
                </div>
