$("document").ready(function () {
    var city;
    const apiKey = "50059088f758ae99de451af53e93c573";
    let queryURL;
    let citiesSearchedObject = {};
    let citiesSearchedObjectsArray = [];
    let ajaxFlag = 0;

    fetch('https://api.openweathermap.org/data/2.5/weather?id=524901&lang=fr&appid=50059088f758ae99de451af53e93c573&units=imperial')
      .then(response => response.json())
      .then(data => {
        var lat = data.coord.lat;
        var lon = data.cood.lon;
        var cityName = data.name;

        return fetch('https://api.openweathermap.org/data/2.5/weather?id=524901&lang=fr&appid=50059088f758ae99de451af53e93c573&units=imperial');
      })
      .then(response => response.json())
      .then(data => {
    ...
    function windyMap(city, cityData) {
      ...
      options = {
        // Required: API key
        key: "50059088f758ae99de451af53e93c573",
